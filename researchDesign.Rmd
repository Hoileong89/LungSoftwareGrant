...
In addition to public availability, some of these algorithms have participated in
independent evaluations/competitions and have performed extremely well:

* A fairly recent large-scale
brain normalization evaluation included the Symmetric Normalization (SyN)
algorithm found in ANTs where it was one of the top performers [@Klein:2009aa] in alignment
of labeled regions.
