...
respiratory cycle) analyses, functional and structural lung image
segmentation, and computation of quantitative image indices as potential
imaging biomarkers. In addition to the software, we will provide both
the input and output data consistent with open-science principles not
only so that other users can it to reproduce our results, but it will
also allow researchers to use it in an unrestricted manner in their own
...
open-source software yields {[}7{]}. Furthermore, it should be
...
paper (e.g., see previous similar offerings from our group {[}8, 9{]}).
Such a comprehensive clinical investigation using these tools will not
only provide insight into the specifics of certain pulmonary pathologies
but will also provide a reproducible mechanism for using the tools
...
concentrating on the years 1999--2004 is given in {[}20{]} which covers
...
\itemsep1pt\parskip0pt\parsep0pt
\item
  whole lung differentiation from the chest wall (e.g., {[}21--24{]})
\item
  bronchial structure extraction (e.g.,{[}25, 26{]}; the many
  ...
  Analysis {[}27{]}),
\item
  vasculature segmentation (e.g., {[}28, 29{]}),
\item
  lobe and/or fissure detection (e.g., {[}30, 31{]}), and
\item
  feature extraction and classification (e.g., {[}32--34{]}).
\end{itemize}
...
ventilation lung imaging (e.g., {[}35{]} which was implemented within
...
normalizations {[}8{]}, and transformations which are particularly
...
B-spline variant {[}8{]}. This evaluation utilized multiple publicly
...
Although the template construction algorithm described in {[}12{]} was
applied to T1-weighted brain data (with the extension of multimodal data
described in {[}15{]}), it is sufficiently generic such that it is
...
to segmentation have proven highly successful in neuroimaging {[}16,
17{]} and these methods translate readily to the pulmonary domain.
...
B-spline SyN registration approach described earlier {[}8{]}.
...
{[}46, 47{]}), cooccurrence and run-length matrix features (e.g., {[}32,
48{]}), attenuation statistics (e.g., {[}49, 50{]}), deformation
measures (e.g., {[}51, 52{]}), and stochastic fractal dimension features
(e.g., {[}32, 50{]}) and those that characterize the airways (e.g.,
{[}53--55{]}).
...
8. Tustison, N. J. and Avants, B. B. ``\textbf{Explicit B-Spline
...
9. Tustison, N. J., Cook, P. A., Klein, A., Song, G., Das, S. R., Duda,
...
10. Avants, B. B., Tustison, N. J., Song, G., Cook, P. A., Klein, A.,
...
11. Avants, B. B., Tustison, N. J., Stauffer, M., Song, G., Wu, B., and
...
12. Avants, B. B., Yushkevich, P., Pluta, J., Minkoff, D., Korczykowski,
...
13. Avants, B. B., Klein, A., Tustison, N. J., Woo, J., and Gee, J. C.
...
14. Das, S. R., Avants, B. B., Grossman, M., and Gee, J. C.
...
15. Tustison, N. J., Shrinidhi, K. L., Wintermark, M., Durst, C. R.,
...
16. Wang, H., Suh, J. W., Das, S. R., Pluta, J., Craige, C., and
...
17. Wang, H. and Yushkevich, P. A. ``\textbf{Multi-Atlas Segmentation
...
19. Menze, B., Reyes, M., and Van Leemput, K. ``\textbf{The Multimodal
...
20. Sluimer, I., Schilham, A., Prokop, M., and Ginneken, B. van.
...
21. De Nunzio, G., Tommasi, E., Agrusti, A., Cataldo, R., De Mitri, I.,
...
22. Prasad, M. N., Brown, M. S., Ahmad, S., Abtin, F., Allen, J., Costa,
...
23. Wang, J., Li, F., and Li, Q. ``\textbf{Automated Segmentation of
Lungs with Severe Interstitial Lung Disease in CT}'' \emph{Med Phys} 36,
no. 10 (2009): 4592--9.

24. Rikxoort, E. M. van, Hoop, B. de, Viergever, M. A., Prokop, M., and
...
25. Zheng, B., Leader, J. K., McMurray, J. M., Park, S. C., Fuhrman, C.
...
26. Nakamura, M., Wada, S., Miki, T., Shimada, Y., Suda, Y., and Tamura,
...
30. Qi, S., Triest, H. J. W. van, Yue, Y., Xu, M., and Kang, Y.
...
31. Doel, T., Gavaghan, D. J., and Grau, V. ``\textbf{Review of
...
32. Uppaluri, R., Hoffman, E. A., Sonka, M., Hartley, P. G.,
...
33. Rosas, I. O., Yao, J., Avila, N. A., Chow, C. K., Gahl, W. A., and
...
34. DeBoer, E. M., Swiercz, W., Heltshe, S. L., Anthony, M. M., Szefler,
