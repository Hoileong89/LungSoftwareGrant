...
software tools for CT, proton, and He-3 pulmonary computational
analysis.}\label{c.2-specific-aim-1-to-develop-a-set-of-open-source-software-tools-for-ct-proton-and-he-3-pulmonary-computational-analysis.}
...
\textbf{Ventilation-based image segmentation.} Developments in MRI
...
{[}42{]}. An example of a set of longitudinal segmentation results are
...
\_\_Quantitative CT indices.\_ Imaging biomarkers for characterizing
...
Insight Toolkit (ITK) of the National Institutes of Health (e.g., {[}43,
44{]}). As an open-source repository for medical image analysis
...
\textbf{Airway and vessel segmentation.} We should propose to implement
...
42. Manj{ó}n, J. V., Coup{é}, P., Mart{í}-Bonmat{í}, L., Collins, D. L.,
...
43. Tustison, N. J. and Gee, J. C. ``\textbf{Run-Length Matrices for
Texture Analysis}'' \emph{Insight Journal} (2008):

44. Tustison, N. J. and Gee, J. C. ``\textbf{Stochastic Fractal
