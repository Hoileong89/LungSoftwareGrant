...
\item
  ...
  pathology. {[}To supportXXX, multi-atlas library for CT XXX.{]} As
...
the development of ITK-SNAP {[}58{]}, a multi-platform open-source tool
...
{[}59, 60{]} and manual delineation functionality, put together into a
...
our 2006 paper on ITK-SNAP {[}58{]} has been cited over 1400 times
...
{[}61{]} which covers computer-aided diagnosis of lung disease and lung
...
{[}62{]}. This proposal constitutes a specific and overdue response to
...
\itemsep1pt\parskip0pt\parsep0pt
\item
  whole lung differentiation from the chest wall (e.g., {[}63--66{]}),
\item
  bronchial structure extraction (e.g., {[}67, 68{]} and the many
  ...
  Analysis {[}69{]}),
\item
  vasculature segmentation (e.g., {[}70, 71{]}),
\item
  lobe and/or fissure detection (e.g., {[}72, 73{]}),
\item
  feature extraction and classification (e.g., {[}74--76{]}), and
\item
  nodule detection (e.g., {[}77{]} and the many submissions to the
  Automatic Nodule Detection (ANODE09) challenge of the 2009 CAD
  Conference of SPIE Medical Imaging {[}78{]}).
\end{itemize}
...
{[}79{]}, co-opting such technologies is complicated by MRI-specific
...
data-driven, subject-specific lobe segmentation {[}73{]}.
...
{[}80{]} to simultaneously estimate the true segmentation from given
...
(e.g., {[}81, 82{]}), distribution of low attenuation areas (LAA) (e.g.,
{[}83, 84{]}), cooccurrence and run-length matrix features (e.g., {[}74,
85{]}), attenuation statistics (e.g., {[}86, 87{]}), deformation
measures (e.g., {[}88, 89{]}), and stochastic fractal dimension features
(e.g., {[}74, 87{]}); and those that characterize the airways (e.g.,
{[}90--92{]}). The former are important for subjects with an
...
contributed the result of our work to the Insight Toolkit (e.g., {[}93,
94{]}).
...
evaluation of 15 airway segmentation algorithms {[}95{]} for the
...
the top 2 performers were the algorithms of {[}96{]} and {[}97{]} with
...
implementation of {[}96{]} and then augment this functionality with some
of our previous work {[}98{]} for removing leakage path candidates.
...
combinations {[}78{]}. This competition included entries from both
...
{[}99{]} where a k-nearest neighbor classification employing local image
...
\textbf{3(c.2.2) Sub-Aim 1b will extend current functionality of
ITK-SNAP for qualitative and quantitative assessment of the results
produced by ITK-Lung.} Several features will be added to ITK-SNAP to
enhance its usability and adoption by those interested in the
lung-specific algorithms developed in the Sub-Aim 1a. In order to assess
image registration results, we plan to extend SNAP to allow for loading
of ITK-style transforms to better visualize the mapping between two
images in separate ITK-SNAP windows. Users will also be able to generate
the entire ITK transform library on the fly using manual annotations and
intensity information increasing interaction during the registration
process. \emph{We believe that the proposed enhancements to the software
will be extremely useful to the general imaging research community and
not just those investigators targeted in this project. Thus, the impact
of this work will be both immediate and broad for pulmonary-driven
science and research.}

\textbf{3(c.2.3) Software engineering.} Both ANTs and ITK-SNAP
...
58. Yushkevich, P. A., Piven, J., Hazlett, H. C., Smith, R. G., Ho, S.,
...
59. Caselles, V., Kimmel, R., and Sapiro, G. ``\textbf{Geodesic Active
Contours}'' \emph{Int J Comput Vision} 22, (1997): 61--79.

60. Zhu, S. and Yuille, A. ``\textbf{Region Competition: Unifying
Snakes, Region Growing, and Bayes/MDL for Multiband Image
Segmentation}'' \emph{IEEE Trans Pattern Anal Mach Intell} 18, no. 9
(1996): 884--900.

61. Sluimer, I., Schilham, A., Prokop, M., and Ginneken, B. van.
...
62. Tustison, N. J., Johnson, H. J., Rohlfing, T., Klein, A., Ghosh, S.
...
63. De Nunzio, G., Tommasi, E., Agrusti, A., Cataldo, R., De Mitri, I.,
...
64. Prasad, M. N., Brown, M. S., Ahmad, S., Abtin, F., Allen, J., Costa,
...
65. Wang, J., Li, F., and Li, Q. ``\textbf{Automated Segmentation of
Lungs with Severe Interstitial Lung Disease in CT}'' \emph{Med Phys} 36,
no. 10 (2009): 4592--9.

66. Rikxoort, E. M. van, Hoop, B. de, Viergever, M. A., Prokop, M., and
...
67. Zheng, B., Leader, J. K., McMurray, J. M., Park, S. C., Fuhrman, C.
...
68. Nakamura, M., Wada, S., Miki, T., Shimada, Y., Suda, Y., and Tamura,
...
72. Qi, S., Triest, H. J. W. van, Yue, Y., Xu, M., and Kang, Y.
...
73. Doel, T., Gavaghan, D. J., and Grau, V. ``\textbf{Review of
...
74. Uppaluri, R., Hoffman, E. A., Sonka, M., Hartley, P. G.,
...
75. Rosas, I. O., Yao, J., Avila, N. A., Chow, C. K., Gahl, W. A., and
...
76. DeBoer, E. M., Swiercz, W., Heltshe, S. L., Anthony, M. M., Szefler,
...
77. Messay, T., Hardie, R. C., and Rogers, S. K. ``\textbf{A New
...
78. Ginneken, B. van, Armato, S. G., 3rd, Hoop, B. de, Vorst, S. van
...
79. Rikxoort, E. M. van and Ginneken, B. van. ``\textbf{Automated
...
80. Warfield, S. K., Zou, K. H., and Wells, W. M. ``\textbf{Simultaneous
...
81. Coxson, H. O., Rogers, R. M., Whittall, K. P., D'yachkova, Y.,
...
82. Perez, A., 4th, Coxson, H. O., Hogg, J. C., Gibson, K., Thompson, P.
...
83. Coxson, H. O. and Rogers, R. M. ``\textbf{New Concepts in the
...
84. Stolk, J., Putter, H., Bakker, E. M., Shaker, S. B., Parr, D. G.,
...
85. Xu, Y., Sonka, M., McLennan, G., Guo, J., and Hoffman, E. A.
...
86. Gevenois, P. A., De Vuyst, P., Sy, M., Scillia, P., Chaminade, L.,
...
87. Hoffman, E. A., Simon, B. A., and McLennan, G. ``\textbf{State of
...
88. Gee, J., Sundaram, T., Hasegawa, I., Uematsu, H., and Hatabu, H.
...
89. Sundaram, T. A. and Gee, J. C. ``\textbf{Towards a Model of Lung
...
90. Aykac, D., Hoffman, E. A., McLennan, G., and Reinhardt, J. M.
...
91. Park, W., Hoffman, E. A., and Sonka, M. ``\textbf{Segmentation of
...
92. Ederle, J. R., Heussel, C. P., Hast, J., Fischer, B., Van Beek, E.
...
93. Tustison, N. J. and Gee, J. C. ``\textbf{Run-Length Matrices for
Texture Analysis}'' \emph{Insight Journal} (2008):

94. Tustison, N. J. and Gee, J. C. ``\textbf{Stochastic Fractal
Dimension Image}'' \emph{Insight Journal} (2009):

95. Lo, P., Ginneken, B. van, Reinhardt, J. M., Yavarna, T., Jong, P. A.
...
96. Feuerstein, M., Kitasaka, T., and Mori, K. ``\textbf{Adaptive Branch
...
97. Lee, J. and Reeves, A. P. ``\textbf{Segmentation of the Airway Tree
...
99. Murphy, K., Ginneken, B. van, Schilham, A. M. R., Hoop, B. J. de,
