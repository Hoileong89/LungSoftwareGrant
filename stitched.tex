...
to make lung imaging datasets publicly available (such as LIDC, RIDER, COPDGene, IELCAP), this
contribution would be innovative as it would meet a critical
...
\textcolor{red}{and PET} for a variety of lung diseases.} These indices
can also be studied not only at any particular single time point, but
also for changes with time.
...
{[}95--97{]}. Although many studies have demonstrated diagnostic and
prognostic value of tumor metabolic burden and morphological information
derived from PET/CT imaging measures {[}97, 98{]}, current ability to
predict treatment response and survival following radiation therapy in
NSCLC is far from satisfactory {[}99{]}. The poor performance of
...
available in other lesions/regions {[}100{]}; second, many
...
subtleties of tumor characteristics and tumor heterogeneity {[}101,
102{]}; and finally, group-level statistical analysis strategies are
typically adopted to evaluate imaging markers, which may not be
effective for personalized prediction {[}103{]}.
...
95. Lardinois, D., Weder, W., Hany, T. F., Kamel, E. M., Korom, S.,
...
96. Lee, H. Y., Lee, H. J., Kim, Y. T., Kang, C. H., Jang, B. G., Chung,
...
97. Horne, Z. D., Clump, D. A., Vargo, J. A., Shah, S., Beriwal, S.,
...
98. Kim, K., Kim, S.-J., Kim, I.-J., Kim, Y. S., Pak, K., and Kim, H.
...
99. Berman, A. T., Ellenberg, S. S., and Simone, C. B., 2nd.
...
100. Ryu, J.-S. and Hyun, I. Y. ``\textbf{Prognostic Impact of
...
101. Chicklore, S., Goh, V., Siddique, M., Roy, A., Marsden, P. K., and
...
102. Depeursinge, A., Foncubierta-Rodriguez, A., Van De Ville, D., and
...
103. Henderson, R. and Keiding, N. ``\textbf{Individual Survival Time
