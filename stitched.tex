...
\item
  \textbf{Specific Aim 2:} \textbf{Evaluate and disseminate the
  ...
  of the evaluation through open-source distribution of the software and
...
computational techniques are motivated by the need for less subjectivity
...
our novel and useful proposal would include the most essential
algorithms for analyzing lung images from different modalities including
CT, 3He, and proton MRI. Many algorithms have been proposed in various
...
several self-contained online examples.
...
processed data. These real-world use cases were solicited representing
as broadly as possible the requirements of the community as well as the
...
processing.} Many of the core programs comprising portions of the
proposed pulmonary software framework have been created and made
...
tasks targeted by this proposal. The following list comprises these core
...
the development of ITK-SNAP {[}56{]}, a multi-platform open-source tool
...
patch-based denoising protocol described in {[}45{]}.
...
Institutes of Health (e.g., {[}90, 91{]}). As an open-source repository
...
5). In an evaluation of 15 airway segmentation algorithms {[}92{]} it
...
of the algorithm developed by our group {[}93{]}. Instead of mixing
...
housed online on dedicated websites {[}94, 95{]}. A similar
infrastructure will be developed for the software resources proposed in
Aim 1.

\subsubsection{3(c.4) \textbf{Specific Aim 2.} Evaluate and disseminate
the developed resources by leveraging use cases from multiple partner
investigators.}\label{c.4-specific-aim-2.-evaluate-and-disseminate-the-developed-resources-by-leveraging-use-cases-from-multiple-partner-investigators.}
...
93. Song, G., Tustison, N., and Gee, J. C. ``\textbf{Airway Tree
Segmentation by Removing Paths of Leakage}'' \emph{Proc. 3rd int.
workshop pulmonary image analysis} (2010): 109--116.

94. Available at \url{http://picsl.upenn.edu/software/ants/}

95. Available at \url{http://www.itksnap.org}
