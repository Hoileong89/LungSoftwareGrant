...
capabilities for a range of generic medical image analysis tasks.  However,
tailored software packages for specific application domains (e.g., lung image analysis) are not
available despite the vast number of algorithms that have been proposed in the literature.
This lack within the neuroscience community was one of the primary motivations for the development
of our Advanced Normalization Tools (ANTs).  ANTs takes advantage of
