...
One of the most significant hurdles \textcolor{red}{to leveraging imaging innovations}
...
software} exists for \textcolor{red}{multi-modality}
...
imaging research at the \textcolor{red}{University of Pennsylvania (Penn)},
...
\textcolor{red}{include intra- and inter-modal} pulmonary image registration,
...
* __Specific Aim 1:__  __Develop ITK-Lung, a set of open-source software tools for CT, PET, \textcolor{red}{and MRI}
...
inspiratory/expiratory \textcolor{red}{and multi-modality} registration, ventilation-based segmentation,
...
As \textcolor{red}{principal developers of the popular, open-source ANTs, ITK-SNAP and ITK packages}
...
lung imaging research.__  \textcolor{red}{This aim will evaluate and refine the proposed framework within the real-world
...
__3(a.1) The importance of analysis tools for research and clinical \textcolor{red]{imaging} investigation.__
...
significant impact.}_  Indeed, a recent
...
textcolor{red}{see Yoo letter of support}.
\textcolor{red}{NLM's position on open-source stems from the} documented benefits
within the targeted communities for which \textcolor{red}{such software} is developed and supported.  In addition to
...
__\textcolor{red}{3(a.3) The challenging dynamic nature of the multi-modality lung imaging
environment demands tools with comprehensive capabilities.}__ \textcolor{red}{There is need
...
images from different modalities, including CT, PET, and MRI.
...
provide all the quantitative analysis scripts as a companion release for \textcolor{red}{our publications}
...
toolkit.  _Similar to the developments that we are proposing \textcolor{red}{in this project},
...
for females in the age range 50--60 \textcolor{red}{years}.
...
__N4 \textcolor{red}{MRI} bias correction.__  Critical to quantitative processing of MRI is the minimization of field
...
[@Tustison:2014ab;@MALF]. _\textcolor{red}{Importantly, we have}
...
__Spatially adaptive denoising.__ Denoising is \textcolor{red}{essential} for data "cleaning" prior to subsequent processing such
...
fusion are \textcolor{red}{first-in-class} software components which have been utilized for
...
![ANTs core processing tools for \textcolor{red}{multi-modal} lung imaging studies.
...
these \textcolor{red}{prototypes} are of high quality and are readily adapted to the pulmonary image
domain.](Figs/coreANtsToolsLung.png)


### 3(c.2) __Specific Aim 1:__   To develop ITK-Lung, a set of open-source software tools for CT, PET, \textcolor{red}{and MRI} pulmonary computational analysis
...
into a \textcolor{red}{paucity} of baseline performance standards with which researchers can compare their
...
pulmonary \textcolor{red}{applications}.  Whereas many current strategies for lung image segmentation employ
...
Since \textcolor{red}{there is} no intensity information inside
the target lung mask and CT atlas lung masks, a simple majority voting strategy \textcolor{red}{is used} to
generate the \textcolor{red}{consensus} labeling for the target image.  \textcolor{red}{Following this step}, we
...
\textcolor{red}{Because} the template construction algorithm described in [@Avants:2010aa]
\textcolor{red}{was
...
registration technology \textcolor{red}{that} has led to a Symmetric
...
for subjects with a bronchitic \textcolor{red}{disease} component. _\textcolor{red}{An important benefit of this
project's multi-modality scope}
 is that many of these measurements can also be directly applied to discriminative
analysis using 3He MRI \textcolor{red}{and PET} for a variety of lung diseases.
 \textcolor{red}{Moreover},
recent work has demonstrated [@Lovinfosse:2016aa]
these indices can  \textcolor{red}{additionally} be studied not only at any particular single time point, but also
...
employs a sharpening of the airway branching edges and \textcolor{red}{the use of} adaptive cuboid volumes
...
flow was first presented in} [@Ostergaard:1996aa] \textcolor{red}{and subsequently extended for use in assessing
...
\textcolor{red}{This estimate is based on} preliminary work \textcolor{red}{in which}
we have developed
...
intensive tasks \textcolor{red}{as well as} other data processing tasks that may be added in the future.
...
airway and vessel segmentations, \textcolor{red}{whereas t}he 1H MRI atlas library will include left/right lung segmentations
...
toward a comprehensive registration solution for \textcolor{red}{multi-modality} imaging studies of the lung. The existence
...
\textcolor{red}{(with quarterly software updates thereafter)},
