...
\textcolor{black}{(Advanced Normalization Tools)} toolkit [@ANTsWebsite], our
 project would include \textcolor{black}{several} essential algorithms for analyzing lung
...
\textcolor{black}{In contrast, we will provide} well-vetted and easy-to-use
...
\textcolor{black}{Another} innovative component of the project is the inclusion of
\textcolor{black}{an} extensive \textcolor{black}{set of} use
cases from leading pulmonary \textcolor{black}{research groups with regression testing performed} using different
...
\textcolor{black}{Tutorial materials, data, and example scripts} drawn from
these \textcolor{black}{studies} will be provided to the public for any interested researcher to
...
provide all the quantitative analysis scripts as a companion release for \textcolor{black}{our publications}
