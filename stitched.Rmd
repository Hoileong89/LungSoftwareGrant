...
prohibitive.}  \textcolor{red}{However, the carefully curated selection of
...
atlas-based lung segmentation} [@zhu2012:aa].
...
the target lung mask and CT atlas lung masks, a simply majority voting strategy \textcolor{red}{is used} to
generate the \textcolor{red}{consensus} labeling for the target image.  Following \textcolor{red}{this step}, we
