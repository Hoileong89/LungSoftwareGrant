...
characterization of lung development and pathology.  [To supportXXX, multi-atlas library for CT XXX.]
...
__3(c.2.2) Sub-Aim 1b will extend current functionality of ITK-SNAP for qualitative
and quantitative assessment of the results produced by ITK-Lung.__  Several features will
be added to ITK-SNAP to enhance its usability and adoption by those interested in the
lung-specific algorithms developed in the Sub-Aim 1a.  In order to assess image
registration results, we plan to extend SNAP to allow for loading of ITK-style transforms
to better visualize the mapping between two images in separate ITK-SNAP windows.  Users will
also be able to generate the entire ITK transform library on the fly using manual annotations
and intensity information increasing interaction during the registration process.
...
__3(c.2.3) Software engineering.__ Both ANTs and ITK-SNAP development, based on a solid foundation
