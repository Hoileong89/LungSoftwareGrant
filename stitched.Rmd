...
Importantly, the goals of this project would
significantly support the National Library of Medicine’s (NLM)
own open-source directives in that
...
within the targeted communities for which the software is developed and supported.  In addition to
...
In [@Tustison:2010aa] \textcolor{red}{introduced "N4," which incorporates both an enhanced fitting
...
__Joint label fusion for multi-atlas segmentation.__  Joint label fusion (JLF) is the current
...
[@Tustison:2014ab], [@MALF]. Importantly, we have
