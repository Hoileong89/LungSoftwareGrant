...
targeted for pulmonary research.  As principal developers of the popular, open-source
...
of which we have proposed in past publications.  These basic tasks include pulmonary image registration,
...
characterization of lung development and pathology.  To maximize usability
code will be developed and distributed within the  Insight Toolkit of the
...
and write-ups, online user support, and conduct of hands-on training workshops.
...
available within ANTs and has proven extremely useful in quantification of
...
also proven incredibly important in applying prior-based information to lung and lobe
...
Medicine Insight Toolkit (ITK) programming library (http://www.itk.org). _The
...
__ Atlas-based lung segmentation.__  Identification of anatomical structure in MRI is often a
...
__ Airway and vessel segmentation.__  In describing the quantitative CT lung indices,
...
based on the work presented in [@Murphy:2009] where a k-nearest neighbor classification employing
...
__3(c.2.2) Sub-Aim 1b will extend current functionality of ITK-SNAP for qualitative assessment
of the results produced by the proposed algorithms in Sub-Aim 1a.__  Several features will
...
_Most crucially, we believe that our track record with ITK-SNAP as well as ANTs demonstrates
...
and outreach efforts. These strengths of the team will be applied to the software and data
developed in the course of this project._
