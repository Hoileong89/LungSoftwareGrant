...
### 3(c.2) Specific Aim 1:   To develop a set of open-source software tools for CT, proton, and He-3 pulmonary computational analysis.
...
__Ventilation-based image segmentation.__  Developments in MRI research utilizing noble gases,
...
__Quantitative CT indices._  Imaging biomarkers for characterizing emphysema in CT have
...
__Airway and vessel segmentation.__  We should propose to implement something here.  We should look at the Slicer/VMTK airway segmentation model.
