...
narrow than those for this project. \textcolor{red}{[NEED to discuss CIP in proposal text]}  Such
...
sharpen the delineation of our contributions. \textcolor{red}{[CHECK that this is done in proposal]}
Additionally, we have removed nodule detection from the project as software/solution
existsxXXXX \textcolor{red}{[FIX this]}.
